using Core.Application.Logging.Serilog.ConfigurationModels;
using Core.Application.Logging.Serilog.Messages;
using Microsoft.Extensions.Configuration;
using Serilog;

namespace Core.Application.Logging.Serilog.Logger;
